      ...
      <Row className="justify-content-center">
        <Col md={4} className="d-flex">
          <Card className="flex-fill text-center">
            <Card.Img variant="top" src="/photos/desks.jpeg" alt="image of tables and desks at an event"/>
            <Card.Body>
        ...
        <Col md={4} className="d-flex">
          <Card className="flex-fill text-center">
            <Card.Img variant="top" src="/photos/books.jpeg" alt='Stack of books' />
            <Card.Body>
        ...
        <Col md={4} className="d-flex">
          <Card className="flex-fill text-center">
            <Card.Img variant="top" src="/photos/umbrellas.jpeg" alt='colorful umbrellas' />
            <Card.Body>
