        ...
        <Col md={4} className="d-flex">
          <Card className="flex-fill text-center">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Explore upcoming events near you, from support groups,
        ...
        <Col md={4} className="d-flex">
          <Card className="flex-fill text-center">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Find resources and information such as medical services,
                education, financial aid, legal assistance, and online guides.
              </Card.Text>
              <Button
                style={{
                  color: "black",
